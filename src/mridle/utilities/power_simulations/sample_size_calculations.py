...
exp = PowerSimulations(sample_sizes=sample_sizes, effect_sizes=effect_sizes, num_trials_per_run=1000,
                       num_runs_for_power_calc=1000, original_test_set_length=6536, significance_level=0.05,
                       base_performance=performance, performance_type=performance_type, num_cpus=1, random_seed=0)
